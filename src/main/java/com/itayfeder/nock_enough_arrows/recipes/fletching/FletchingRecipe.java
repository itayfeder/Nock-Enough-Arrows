...
public class FletchingRecipe implements Recipe<Container> {
    ...
    public static class Serializer<T extends FletchingRecipe> implements RecipeSerializer<FletchingRecipe> {
        Serializer() {
            //this.setRegistryName(new ResourceLocation(ArcherMod.MOD_ID, "fletching"));
        }
