...
public class ClientQuiverTooltip implements ClientTooltipComponent {
    ...
    public ClientQuiverTooltip(QuiverTooltip p_169873_) {
        ...
        this.quiver = p_169873_.getQuiver();
    ...
    private void renderSlot(int p_194027_, int p_194028_, int p_194029_, boolean p_194030_, Font p_194031_, PoseStack p_194032_, ItemRenderer p_194033_, int p_194034_) {
        if (p_194029_ >= this.items.size()) {
            ...
            int selected = QuiverItem.getSelected(quiver);
            QuiverItemStackHandler quiverItemStackHandler = ((QuiverItem) quiver.getItem()).getQuiverItemStackHandler(quiver);

            if (itemstack == quiverItemStackHandler.getStackInSlot(selected)) {
